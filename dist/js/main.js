...
function matroskinAnimations() {
  ScrollTrigger.matchMedia({
    '(min-width: 768px)': function minWidth768px() {
      ...
      gsap.fromTo('.matroskin-calibr__image', {
        yPercent: -100
      }, {
        yPercent: 0,
        duration: 1,
      ...
      gsap.fromTo('.matroskin-detail img', {
        yPercent: 100
      }, {
        yPercent: 0,
        duration: 1,
      ...
      gsap.fromTo('.buy-matroskin-watch__image', {
        x: -100,
        opacity: 0
      }, {
        x: 0,
        ...
        ease: 'ease-in',
        scrollTrigger: {
          trigger: '.buy-matroskin-watch',
          //scrub: true,
          start: 'top center' //markers: true,

        }
      });
      gsap.fromTo('.buy-matroskin-watch__text', {
        x: 100,
        opacity: 0
      }, {
        x: 0,
